/*
package com.example.apigateway.aop;
...
public class LoggingAspect {
    ...
    @Around(value = "within(com.example.apigateway.filter.AuthenticationFilter)")
    ...
    @Pointcut("within(com.example.apigateway.customexception.*)")
