...
public class LoggingAspect {
    ...
    @Around(value = "within(com.example.bookingservice.service.BookingServiceImpl) || within(com.example.bookingservice.externalservice.*)")
    ...
    @Pointcut("within(com.example.bookingservice.customexception.*)")
